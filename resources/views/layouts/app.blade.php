...
<head>
    ...
    <!-- Scripts -->    
    <script src="{{ asset('css/bower_components/jquery/dist/jquery.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/jquery-ui/jquery-ui.min.js') }}" defer></script>
    <script>
      $.widget.bridge('uibutton', $.ui.button);
    </script>
    <script src="{{ asset('css/bower_components/bootstrap/dist/js/bootstrap.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/raphael/raphael.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/morris.js/morris.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}" defer></script>
    ...
    <script src="{{ asset('css/bower_components/jquery-knob/dist/jquery.knob.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/moment/min/moment.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}" defer></script>
    <script src="{{ asset('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}" defer></script>
    <script src="{{ asset('css/bower_components/fastclick/lib/fastclick.js') }}" defer></script>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Usuarios de Aplicacion</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li>
                 @if (Route::has('register'))
                                    <a class="nav-link" href="{{ route('register') }}"><i class="fa fa-user-plus"></i>Registrar Usuario</a>
                                @endif
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://adminlte.io">KoiFishWeb</a>.</strong> All rights
    reserved.
  </footer>
